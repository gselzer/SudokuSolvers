...
def generate_model():
    ...
    conv1 = keras.layers.Conv2D(8, kernel_size=(3,3), activation='relu', padding='same')(input_norm)
    norm1 = keras.layers.BatchNormalization()(conv1)

    conv2 = keras.layers.Conv2D(8, kernel_size=(3,3), activation='relu', padding='same')(norm1)
    norm2 = keras.layers.BatchNormalization()(conv2)

    conv3 = keras.layers.Conv2D(16, kernel_size=(1,1), activation='relu', padding='same')(norm2)
