...
"""
5-layer CNN used for hyperparameter testing
- layer filters half of original number
...
def generate_model():
    ...
    conv1 = keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same')(input_norm)
    norm1 = keras.layers.BatchNormalization()(conv1)

    conv2 = keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same')(norm1)
    norm2 = keras.layers.BatchNormalization()(conv2)

    conv3 = keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same')(norm2)
    norm3 = keras.layers.BatchNormalization()(conv3)

    conv4 = keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same')(norm3)
    norm4 = keras.layers.BatchNormalization()(conv4)

    conv5 = keras.layers.Conv2D(64, kernel_size=(1,1), activation='relu', padding='same')(norm4)
    norm5 = keras.layers.BatchNormalization()(conv5)

    flat = keras.layers.Flatten()(norm5)
