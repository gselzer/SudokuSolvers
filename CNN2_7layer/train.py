...
"""
7-layer CNN used for hyperparameter testing
...
def generate_model():
    ...
    conv3 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same')(norm2)
    norm3 = keras.layers.BatchNormalization()(conv3)

    conv4 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same')(norm3)
    norm4 = keras.layers.BatchNormalization()(conv4)

    conv5 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same')(norm4)
    norm5 = keras.layers.BatchNormalization()(conv5)

    conv6 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same')(norm5)
    norm6 = keras.layers.BatchNormalization()(conv6)

    conv7 = keras.layers.Conv2D(128, kernel_size=(1,1), activation='relu', padding='same')(norm6)
    norm7 = keras.layers.BatchNormalization()(conv7)

    flat = keras.layers.Flatten()(norm7)
