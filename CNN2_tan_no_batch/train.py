...
def generate_model():
    ...
    conv1 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='tanh', padding='same')(input_reshape)

    conv2 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='tanh', padding='same')(conv1)

    conv3 = keras.layers.Conv2D(128, kernel_size=(1,1), activation='tanh', padding='same')(conv2)
