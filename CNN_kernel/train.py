...
def tower_3x3(prev_layer):
    conv1 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same')(prev_layer)
...
def tower_1xn2(prev_layer):
    conv1 = keras.layers.Conv2D(64, kernel_size=(1,n2), activation='relu', padding='same')(prev_layer)
    norm1 = keras.layers.BatchNormalization()(conv1)

    conv2 = keras.layers.Conv2D(64, kernel_size=(1,n2), activation='relu', padding='same')(norm1)
    norm2 = keras.layers.BatchNormalization()(conv2)
...
def tower_n2x1(prev_layer):
    conv1 = keras.layers.Conv2D(64, kernel_size=(n2,1), activation='relu', padding='same')(prev_layer)
    norm1 = keras.layers.BatchNormalization()(conv1)

    conv2 = keras.layers.Conv2D(64, kernel_size=(n2,1), activation='relu', padding='same')(norm1)
    norm2 = keras.layers.BatchNormalization()(conv2)
...
def generate_model():
    ...
    tower1 = tower_3x3(input_norm)
    tower2 = tower_1xn2(input_norm)
    tower3 = tower_n2x1(input_norm)

    merged = keras.layers.Concatenate()([tower1, tower2, tower3])
