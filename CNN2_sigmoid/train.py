...
- changed to use sigmoid activation
...
def generate_model():
    ...
    conv1 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='sigmoid', padding='same')(input_norm)
    norm1 = keras.layers.BatchNormalization()(conv1)

    conv2 = keras.layers.Conv2D(64, kernel_size=(3,3), activation='sigmoid', padding='same')(norm1)
    norm2 = keras.layers.BatchNormalization()(conv2)

    conv3 = keras.layers.Conv2D(128, kernel_size=(1,1), activation='sigmoid', padding='same')(norm2)
